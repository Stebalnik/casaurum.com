...
function home(route) {
  ...
  return `
    <section class="hero">
      <picture class="hero-media">${img("hero-luxury-wall-panels-living-room", route.lang, "eager")}</picture>
      <div class="hero-copy">
