...
export function summarizeCrmLead(summary) {
  ...
  return {
    ...
    projectType: lead.projectType || lead.projectCategory || lead.project_type || deal?.project_type || "",
    service: lead.packageInterest || lead.vertical || lead.serviceNeeded || lead.service || deal?.service || "",
    budget: lead.budget || deal?.budget || "",
    timeline: lead.timeline || deal?.timeline || "",
    leadType: lead.leadTypeClassificationLabel || lead.lead_type_classification || lead.leadType || "",
    leadIntent: lead.leadIntent || lead.intent || "",
    projectCategory: lead.projectCategory || lead.objectType || "",
...
function leadToRow(lead) {
  return {
    ...
    vertical: lead.vertical || "",
    service: lead.service || lead.serviceNeeded || "",
    intent: lead.leadIntent || lead.intent || "",
    object_type: lead.projectCategory || lead.objectType || "",
    ...
    timeline: lead.timeline || "",
    project_type: lead.projectType || lead.projectCategory || "",
    service_needed: lead.serviceNeeded || lead.packageInterest || "",
    page_id: lead.pageId || "",
